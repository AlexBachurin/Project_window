...
var forms = function forms(state, allModalsSelector, calcInputsSelector, selectSelector) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault(); //show message and spinner on loading
...
var tabs = function tabs(tabContentSelector, tabLinksWrapperSelector, tabLinksSelector, activeClass) {
  ...
  var tabContent = document.querySelectorAll(tabContentSelector),
      ...
      tabLinks = document.querySelectorAll(tabLinksSelector); //helper to show needed tab , default show first tab
  ...
  hideTabs();
  showTabs();
  tabLinksWrapper.addEventListener('click', function (e) {
    e.preventDefault();
    var target = e.target; //проверяем что кликнули в нужный таб или в его дочерний элемент

    if (target && (target.classList.contains(tabLinksSelector.replace(/\./, "")) || target.parentNode.classList.contains(tabLinksSelector.replace(/\./, "")))) {
